...
export default function OrgComplaintsPage() {
  ...
  const fetchComplaints = async () => {
    ...
    if (config.isMockMode) {
      setComplaints([
        { id: "comp_1", description: "Service wasn't provided this week.", status: "submitted", date: "2023-11-20", residentId: "res_123" },
        { id: "comp_2", description: "Unit was damaged during operations.", status: "investigating", date: "2023-10-15", residentId: "res_456" }
      ]);
      setTotalPages(1);
      setTotalCount(2);
      setLoading(false);
