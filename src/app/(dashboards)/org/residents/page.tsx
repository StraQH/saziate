...
import { formatCurrency, calculateResidentBill } from "@/lib/utils";
import { AddResidentModal } from "@/components/org/AddResidentModal";
import { ImportCSVModal } from "@/components/org/ImportCSVModal";
import { SendSMSModal } from "@/components/org/SendSMSModal";
import { MOCK_RESIDENTS, type Resident, MOCK_ORG_ID } from "@/lib/mockdata";
...
export default function OrgResidentsPage() {
  ...
  }, [page, limit, debouncedSearch, user?.orgId]);
              ...
              {residents.map((r) => {
                ...
                return (
                  <tr key={r.id}>
                    ...
                    <td className="text-sm">{r.zone}</td>
                    <td>
                    ...
                    <td className="font-semibold text-sm">{formatCurrency(totalAmount)}</td>
                    <td>
