    ...
    if (config.isMockMode) {
      ...
      return new Response(
        JSON.stringify([
          {
            id: "inv-001",
            baseAmount: config.locality.rates.general.residential,
            platformFee: Math.round(config.locality.rates.general.residential * config.PLATFORM_FEE_RATE),
            totalAmount: config.locality.rates.general.residential + Math.round(config.locality.rates.general.residential * config.PLATFORM_FEE_RATE),
            dueDate: "25 Jul 2026",
            status: "pending",
            billingPeriod: "July 2026",
            referenceCode: "SZREF001",
          },
          {
            id: "inv-002",
            baseAmount: config.locality.rates.general.residential,
