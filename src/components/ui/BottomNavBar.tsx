...
export function BottomNavBar() {
  ...
  const links = [
    { href: "/resident", icon: LayoutDashboard, label: "Home" },
    { href: "/resident/billing", icon: CreditCard, label: "Billing" },
    { href: "/resident/support", icon: MessageSquare, label: "Support" },
